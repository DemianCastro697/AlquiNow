...
INSERT INTO `comprador` VALUES (1,NULL,NULL),(7,NULL,NULL),(8,NULL,NULL);
...
INSERT INTO `lista_deseos` VALUES (16,7,1,'2026-09-08');
...
CREATE TABLE `propiedad` (
  ...
  `descripcion` text,
  `disponibilidad_inmediata` tinyint DEFAULT '0',
...
INSERT INTO `propiedad` VALUES (1,NULL,NULL,'Av. Alem',1253,NULL,'Bahía Blanca','Buenos Aires','Argentina',25000.00,NULL,4,NULL,'Departamento de prueba para validar el sistema de reservas.',0,NULL),(2,2,NULL,'Martiniano Rodriguez ',137,NULL,'Bahia Blanca','Buenos Aires','Argentina',50.00,30,3,NULL,'Departamento nuevo en zona centro',1,NULL),(3,7,NULL,'Vieytes',542,NULL,'Bahia Blanca','Buenos Aires','Argentina',70.00,35,2,NULL,'Departamento amoblado nuevo',1,NULL),(4,7,NULL,'Vieytes',542,NULL,'Bahia Blanca','Buenos Aires','Argentina',70.00,35,2,NULL,'Departamento amoblado nuevo',1,NULL),(5,7,NULL,'Vieytes',542,NULL,'Bahia Blanca','Buenos Aires','Argentina',70.00,35,2,NULL,'Departamento amoblado nuevo',1,NULL);
...
CREATE TABLE `usuario` (
  ...
  `es_huesped` tinyint(1) DEFAULT '1',
...
INSERT INTO `usuario` VALUES (1,'$2a$12$kAwExYfPbRyJ8H4eCk2gNeO51dWm9V1QPV0vmediEzuuG5/RzzkBu','46920939','pepito123@gmail.com','2914146715',1,1,0,NULL),(2,'$2a$12$DEArvVrsMiYHN81M.GJJ6.cZ2d.gxWQ4lKmv9WvVmeeFh5yhQilre','46939969','vendedor@alquinow.com','2914126513',1,1,0,NULL),(7,'$2a$12$iO4yT1.mlUa3DR3A/HDwmOs2PP5jTGlxD55nF0uTDEosrqkEmErH.','46939920','demiancastro697@gmail.com','+5492914136815',1,1,1,NULL),(8,'$2a$12$9.4u07xnvw50BIeEbEdpPOSByQgXPvQMDCTEnHjDpkVTGaI4vyuuO','46939920','salasprueba1@gmail.com','+5492914136815',1,1,1,NULL);
...
INSERT INTO `vendedor` VALUES (2,NULL,NULL,0),(7,NULL,NULL,0),(8,NULL,NULL,0);
...
-- Dump completed on 2026-09-08 21:04:05
